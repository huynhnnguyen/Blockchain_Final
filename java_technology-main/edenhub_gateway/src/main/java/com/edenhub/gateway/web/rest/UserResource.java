...
import com.edenhub.gateway.service.MailService;
...
public class UserResource {
    ...
    public UserResource(UserService userService, UserRepository userRepository, MailService mailService, SysServiceProxy sysServiceProxy, UserServiceInterface userServiceInterface) {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
        	throw new BadRequestAlertException(EnumErrors.ID_EXISTS);
            ...
            User newUser = userServiceInterface.createUser(userDTO);
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.SYS + "\")")
    public ResponseEntity<User> createUserEmployees(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        log.debug("REST request to save User : {}", userDTO);
        ...
        if (userDTO.getId() != null) {
            ...
            userDTO.setAuthorities(authors);
            User newUser = userServiceInterface.createUser(userDTO);
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        userServiceInterface.deleteUser(login);
    ...
    /**
     * permit owner delete themself account and all their staff
     * @param login
     * @return
     */

    @DeleteMapping("/users/employees")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.SYS + "\")")
    public ResponseEntity<Void> deleteUserBySys(@RequestParam String login) {
        log.debug("REST request to delete User: {}", login);
        userServiceInterface.deleteUser(login);
        return ResponseEntity.noContent().headers(HeaderUtil.createAlert(applicationName,  "A user is deleted with identifier " + login, login)).build();
    }
    ...
    /**
     * permit owner delete employees account
     * @param login
     * @return
     */
    @DeleteMapping("/owner/employees")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.SYS + "\")")
    public ResponseEntity<Void> deleteUserByOwner(@RequestParam String login) {
        log.debug("REST request to delete User: {}", login);
        userService.deleteUserEmployees(login);
        return ResponseEntity.noContent().headers(HeaderUtil.createAlert(applicationName,  "A user is deleted with identifier " + login, login)).build();
    }
}
